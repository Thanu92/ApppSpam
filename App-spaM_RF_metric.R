...
library(phangorn)
library(ggplot2)
files <- list.files(path="/home/thanu/Desktop/App-SpaM/build", pattern="*[0-9]{1,2}_*.nwk", full.names=TRUE, recursive=FALSE)
...
names(treeList) <- gsub("/home/thanu/Desktop/App-SpaM/build/", "", files)
